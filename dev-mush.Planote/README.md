# Planote Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/dev-mush.Planote/CHANGELOG.md) for latest updates/changes to this plugin.

## About This Plugin 

Planote helps with the plan side of Noteplan
